...
export const projects = [
    {
        ...
        info:'BookSwap is a platform where users can trade, sell, or donate books with others in their community. It allows users to list books, browse available books, interact with other users, and arrange book exchanges or purchases. This app was created as a SoftUni project in course ReactJS-feb.',
        features:[
            "User Authentication",
            "Book Listings",
            "Trade System",
