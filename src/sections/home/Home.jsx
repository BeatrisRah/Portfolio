...
export default function Home() {
    ...
    return (
        <Element name="home" className="min-h-screen relative bg-transparent p-8 overflow-hidden">
            <pre className="absolute text-pink-500/60 z-0 right-10 lg:right-40 -top-10 rotate-3">
                {`
             ⢀⣀⠀⠀⠀⠀⠀⢀⣀⠀
            ⢠⣯⢬⣷⡀⠀⠀⣴⡯⢌⣧
            ⠸⣿⠀⠹⣷⠀⢸⡝⠀⢸⡿
            ...
            <div className="mb-5 w-full md:w-10/12 ml-10">
            ...
            <div className="w-full flex-wrap flex gap-3 lg:flex-nowrap">
                <div className="flex lg:flex-col gap-5 w-full items-end lg:w-1/3">
                    <img src="/me.jpg" className="w-1/3 lg:w-10/12 h-[250px] lg:h-[500px] object-cover mx-auto" />
                    <Box className='w-2/3 lg:w-10/12 h-full lg:h-40 mx-auto' >
                        <ul className="flex flex-col h-full justify-evenly gap-5 lg:gap-3">
                            ...
                            <li className="flex gap-3 ml-25 lg:ml-0 items-center text-2xl lg:text-xl text-[#ff57c4] hover:text-pink-300 hover:drop-shadow-glow transition duration-300 ease-in-out">
