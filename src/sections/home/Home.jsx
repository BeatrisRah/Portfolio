...
export default function Home() {
    ...
    return (
        <Element name="home" className="min-h-screen relative bg-transparent p-3 md:p-8 overflow-hidden">
            <pre className="absolute text-pink-500/60 -z-1 right-10 lg:right-40 -top-10 rotate-3">
                {`
             ⢀⣀⠀⠀⠀⠀⠀⢀⣀⠀
            ⢠⣯⢬⣷⡀⠀⠀⣴⡯⢌⣧
            ⠸⣿⠀⠹⣷⠀⢸⡝⠀⢸⡿
            ...
            <div className="mb-5 w-full md:w-10/12 md:ml-10">
                <p className="text-3xl text-white">Beatris Rahimi</p>
                <h1 className="jersay text-5xl lg:text-7xl text-white tracking-wider">Junior Software Engineer</h1>
            </div>

            <div className="w-full flex-wrap flex gap-3 lg:flex-nowrap">

                <div className="flex lg:flex-col gap-2 md:gap-5 w-full items-end lg:w-1/3">

                    <img src="/me.jpg" className="w-1/2 md:w-1/3 lg:w-10/12 h-[250px] lg:h-[500px] object-cover mx-auto" />
                    <Box className='w-1/2 md:w-2/3 lg:w-10/12 h-full lg:h-40 mx-auto' >

                        <ul className="flex flex-col h-full justify-evenly gap-5 lg:gap-3">
                            <li className="flex gap-4 items-center md:text-xl">
                            ...
                            <li className="flex gap-3 md:ml-25 lg:ml-0 items-center md:text-2xl lg:text-xl text-[#ff57c4] hover:text-pink-300 hover:drop-shadow-glow transition duration-300 ease-in-out">
                ...
                <div className="flex flex-wrap gap-5 lg:w-2/3">
                    ...
                    <Box
                        ...
                        className="w-full"
                    >
                        <DonutChart className="md:w-9/12 mx-auto" />
                    </Box>
                </div>
            </div>
        </Element>
