...
export default function TopNavigation() {
   return (
    <div className="sticky top-0 z-20 md:w-11/12 xl:w-full px-6 py-4 flex items-center">
        <SmallMenu />

        <div className="flex-1" />

        <div className="flex items-center gap-4">
        <a href="https://github.com/BeatrisRah" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:underline w-8 h-8 md:w-9 md:h-9">
        ...
        <a href="https://www.linkedin.com/in/beatris-rahimi/" target="_blank" className="w-8 h-8 md:w-9 md:h-9 text-pink-500 hover:underline">
            <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={100} height={100} viewBox="0,0,256,256">
        ...
        <a href="mailto:beatris.m.rahimi@gmail.com" className="w-7 h-7 md:w-9 md:h-9 text-pink-500 hover:underline">
